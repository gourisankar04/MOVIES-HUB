...
API_ID = int(environ.get('API_ID', '20383184'))
API_HASH = environ.get('API_HASH', 'c0809b9a853378dd901e7bf7978b335f')
BOT_TOKEN = environ.get('BOT_TOKEN', "7932484199:AAEAjR60xlm0kKAQVy3Y3qzXCguWCUpCxI4")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6227723550').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002764464732'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002763035991').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002585671240') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002393506748')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002849451173').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nemesisblue2004:<ubdWcUn2kGvGapp0d>@cluster0.lilmrzl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', https://t.me/+Ev6A4eYdQqsxNDA1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+ZadLPJAXu_82MWI1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+n8O7DHS0Q7owNjk9') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/kingvj01-owner')
